...
class Inventory extends EventEmitter {
    ...
    installHooks() {
        ...
        this.installHook('S_INVEN_USERDATA', this.parent.mod.majorPatchVersion >= 87 ? 2 : 1, event => {
        ...
        this.installHook('S_ITEMLIST', this.parent.mod.majorPatchVersion >= 87 ? 3 : 2, event => {
            if (!this.parent.me.is(event.gameId))
                return;
